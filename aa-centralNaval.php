...
require_once "aa-separaPosicao.php";
require_once "aa-posicionar.php"; // Garanta que este não executa pedirPosicoes por si só
require_once "aa-matrizbase.php";
require_once "aa-letraPraNum.php"; // Assumindo que este contém substituirLetras e não tem duplicatas de matrizbase.php
require_once "aa-posicionarBot.php";
